...
tello2_address = ('192.168.0.104', 8889)
tello3_address = ('192.168.0.102', 8889)
...
# All three drones take off together
send("takeoff", 8)

# All three drones move forward 100 cm together
send("forward 100", 5)

# All three drones land together
send("land", 5)

# Print message
print("Mission completed successfully: all three drones flew forward 100 cm.")
